...
import com.example.demo.src.user.model.GetStoreRes;
import com.example.demo.src.user.model.PatchStoreInfoReq;
import com.example.demo.src.user.model.PatchStoreNameReq;
import com.example.demo.src.user.model.PatchStorePhoneReq;
import com.example.demo.src.user.model.PatchStorePicReq;
import com.example.demo.src.user.model.PatchStoreTimeReq;
import com.example.demo.src.user.model.PostStoreReq;
